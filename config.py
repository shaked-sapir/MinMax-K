...
sanity_position: list[str] = ["r2qk2r/pb4pp/1n2Pb2/2B2Q2/p1p5/2P5/2B2PPP/RN2R1K1 w - - 1 0"] #white mates in two
...
clear_white_win_positions: list[str] = [
    ...
    # "8/p1r2kpp/2p2p2/r2p1KPP/8/8/8/1R2R3 w - - 1 0", # white mates in 4: 1. Q:e8+ k:e8 2. RAe1+ be4 3. R:e4+ kd8 4. Rf8# TODO: handle duplication
]
...
test_conf = {
    ...
    "turns_limit": 10,
    "games": sanity_position + clear_white_win_positions
}
